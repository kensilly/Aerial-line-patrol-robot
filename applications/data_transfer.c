...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		ANO_DT_Send_Status(PixFlow_Roll,PixFlow_Pitch,Yaw,(0.1f *baro_fusion.fusion_displacement.out),0,fly_ready);	
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		 f.send_senser = 0;// 
		 ANO_DT_Send_Senser((int16_t)X_Speed,(int16_t)Y_Speed,(int16_t)turn_flag,
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid5 = 0;
		//ANO_DT_Send_PID(5,angle_max,0,0,0,0,0,0,0,0);
		ANO_DT_Send_PID(5,x_offset_arg.kp,x_offset_arg.ki,x_offset_arg.kd,y_offset_arg.kp,y_offset_arg.ki,y_offset_arg.kd,angle_max,speed_max,0);
	}
	else if(f.send_pid6)
	{
		f.send_pid6 = 0;
